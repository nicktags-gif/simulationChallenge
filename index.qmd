...
We ended up with a net change of $793.61. I would be happy with this result, as we were able to gain exactly the amount we expected to. With the 15 flips, we got exactly the expected value and the success rate was 60%.
...
print(f"\n=== KEY INSIGHTS ===")
print(f"• The standard deviation is {prob_analysis['std_as_pct_of_mean']:.1f}% of the mean, indicating extremely high volatility")
print(f"• Only {prob_analysis['prob_within_one_std']:.1f}% of simulations fall within one standard deviation of the mean")
print(f"• The probability of losing money ({prob_analysis['prob_loss']:.1f}%) is much higher than winning ({prob_analysis['prob_win']:.1f}%)")
print(f"• When you lose, you lose an average of {abs(prob_analysis['avg_loss_pct']):.1f}% of your initial investment")
print(f"• When you win, you gain an average of {prob_analysis['avg_gain_pct']:.1f}% of your initial investment")
```
